...
SSH_PORT=22
SSH_USER=delucks
SSH_TARGET_DIR=/var/www/jamieluck.com/
...
help:
	...
	@echo '   make venv                           create a virtual environment in the current directory with Pelican dependencies'
...
.PHONY: html help clean regenerate serve serve-global devserver publish ssh_upload rsync_upload pygments sass
